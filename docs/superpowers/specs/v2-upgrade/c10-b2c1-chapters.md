...
|---|---|---|---|---|---|
| 66 | 피동 | ✅ | ✅ pass | ✅ | blocker 1(사다 드릴)→수정·재검 해소 |
| 67 | 간접화법 축약 | ✅ | ✅ pass | ✅ | blocker 1(orderWords 자유어순)→수정·재검 해소 |
| 68 | 이유·회상 인과 | ✅ | ✅ pass | ✅ | 결함 0 |
| 69 | 완료·아쉬움·미수 | ✅ | ✅ pass | ✅ | minor 2(발음 표기)→해소 |
| 70 | 문어 연결어미·명사화 (재설계) | ✅ | ✅ pass | ✅ | 원안 "격식 문어체"는 기존 63과와 중복 → 재설계(스펙 표 참조) · minor 2 해소 |
| 71 | 뉴스·공지 독해 | ✅ | ✅ pass | ✅ | minor 1(시제)→해소 |
| 72 | 관용구·속담 | ✅ | ✅ pass | ✅ | 결함 0 · 계열=노트 구조는 감독자 승인 재해석 |

저작=오퍼스 / 감사=소넷(별도 컨텍스트, blocker 0 루프 2회) / 감독=Fable.
게이트: validate-rich-chapter 7/7 PASS · validate-curriculum-path PASS · build-app-data 그린(72챕터) ·
vitest 394 그린. 경로: B2 밴드에 66~69, C1 밴드(63 뒤)에 70~72, Synthesis(65) 최말미 유지.
**남은 릴리스 게이트: 사용자 스팟체크 35문장**(스펙 "언어 품질의 한계와 책임" — 챕터당 5문장,
부자연 2건 이상이면 그 챕터 전면 재저작). 통과 전까지 사이트 배포·한입 반입(지시 25) 보류.
