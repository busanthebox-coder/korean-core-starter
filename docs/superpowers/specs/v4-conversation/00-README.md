...
| nuance/commonMistakes 커버리지 ~100%, 클러스터 상호참조도 다수 존재. 그러나 사전 상세의 접힌 콜아웃에만 있고 **나란히 비교하는 화면 없음**. 짝 항목 부재도 있음(실측 정정: 죄송해요·알았어요·좋아요·됐어요 부재 — C14에서 시드 추가) | 설명이 "없는" 게 아니라 "안 보이는" 것 | C14 |
